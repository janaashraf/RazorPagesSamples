...
namespace RazorSamples.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, RazorSamples.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((RazorSamples.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", RazorSamples.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(RazorSamples.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(RazorSamples.EntityType)))
			{
				var factory = GetFactory((RazorSamples.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the RazorSamples.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(RazorSamples.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case RazorSamples.EntityType.UserEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the RazorSamples.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (RazorSamples.EntityType)Enum.Parse(typeof(RazorSamples.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((RazorSamples.EntityType)Enum.Parse(typeof(RazorSamples.EntityType), leftOperandEntityName, false), joinType, (RazorSamples.EntityType)Enum.Parse(typeof(RazorSamples.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (RazorSamples.EntityType)Enum.Parse(typeof(RazorSamples.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((RazorSamples.EntityType)entityTypeValue); }
